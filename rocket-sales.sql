...
CREATE TABLE `leads` (
  ...
  `veiculoInteresse` varchar(50) NOT NULL,
  `vendedor` varchar(50) NOT NULL,
  `testdrive` tinyint DEFAULT NULL,
  `testdriveMotivo` varchar(500) DEFAULT NULL,
  `testDriveHora` datetime DEFAULT NULL,
  `statusNegociacao` varchar(50) NOT NULL DEFAULT 'Novo',
  `numeroPedido` varchar(50) DEFAULT NULL,
  `motivoDesistencia` varchar(500) DEFAULT NULL,
  `horaEntrada` datetime NOT NULL,
  `horaSaida` datetime DEFAULT NULL,
  `observacao` varchar(500) DEFAULT NULL,
  `comoconheceu` varchar(50) DEFAULT NULL,
  `createdAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updatedAt` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
) ENGINE=InnoDB AUTO_INCREMENT=84 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='			';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-07-07 14:54:30
